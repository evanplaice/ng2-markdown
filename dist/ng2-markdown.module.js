(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@angular/common/http"), require("@angular/core"));
	else if(typeof define === 'function' && define.amd)
		define(["@angular/common/http", "@angular/core"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("@angular/common/http"), require("@angular/core")) : factory(root["@angular/common/http"], root["@angular/core"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(window, function(__WEBPACK_EXTERNAL_MODULE__angular_common_http__, __WEBPACK_EXTERNAL_MODULE__angular_core__) {
...
var _showdown = __webpack_require__(/*! showdown */ "./node_modules/showdown/dist/showdown.js");
...
var MarkdownComponent = exports.MarkdownComponent = (_dec = (0, _core.Component)({
  ...
  _createClass(MarkdownComponent, [{
    ...
    value: function fromFile(src) {
      ...
      this.http.get(src, { responseType: 'text' }).toPromise().then(function (res) {
        return _this.prepare(res);
...
(0, _core.Inject)(_http.HttpClient)(MarkdownComponent, null, 1);
